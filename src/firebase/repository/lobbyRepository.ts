...
export async function setDiscussionReady(lobbyId: string, uid: string, ready: boolean): Promise<void> {
  await updateDoc(playerDocRef(lobbyId, uid), { discussionReady: ready })
}
